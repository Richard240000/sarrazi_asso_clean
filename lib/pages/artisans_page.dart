...
class _ArtisansPageState extends State<ArtisansPage> {
  ...
  Widget build(BuildContext context) {
    return BasePage(title: "Artisans", body: getBody());
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Icon(Icons.person_pin_circle, size: 32, color: Colors.blue[800]),
                          Expanded(
                            child: Text(artisan['intitule'], style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                          ),
                        ],
                      ),
                      Align(
