...
import 'package:sarrazi_asso_clean/pages/pdf_viewer_page.dart';
      ...
      await Navigator.of(context).push(
        MaterialPageRoute(
          builder: (_) => PdfViewerPage(
            filePath: localPath,
            title: titre.isEmpty ? 'Document PDF' : titre,
          ),
        ),
      );
    } catch (_) {
  ...
  Widget _body() {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final DateTime date =
            DateTime.tryParse((doc['date_mise_en_ligne'] ?? '').toString()) ??
            DateTime.now();
        ...
        return Card(
          child: ListTile(
            ...
            subtitle: Column(
              ...
              children: [
                Text(
                  "Paru le ${DateFormat("dd/MM/yyyy à HH:mm").format(date)}",
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: Color(0xFF00796B).withAlpha(200),
                      ...
                      child: IconButton(
                        ...
                        tooltip: 'Ouvrir',
                        onPressed: () =>
                            lireDocument(url, titre), // ✅ lecture rapide
                      ),
                    ),
                    Container(
                      height: 40,
                      width: 40,
                      decoration: BoxDecoration(
                        color: Color(0xFF0277BD).withAlpha(200),
                        shape: BoxShape.circle,
                      ),
                      child: IconButton(
                        icon: Icon(
                        ...
                        tooltip: 'Partager',
                        onPressed: () =>
                            partagerDocument(url, titre), // ✅ garder / envoyer
                      ),
                    ),
                  ],
                ),
