...
class AnnuairePage extends StatefulWidget {
  const AnnuairePage({Key? key}) : super(key: key);
...
class _AnnuairePageState extends State<AnnuairePage> {
  ...
  Future<void> _verifierConnexion() async {
    ...
    if (!(prefs.getBool('isConnectedToAnnuaire') ?? false)) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Annuaire', style: GoogleFonts.poppins()),
              ...
              child: _isLoading
                  ...
                  : _annuaire.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) => _buildMemberCard(_annuaire[index]),
                        ),
            ),
          ],
        ),
