...
class _ArtisansPageState extends State<ArtisansPage> {
  ...
  Future<void> fetchArtisans() async {
    try {
      final response = await http.get(Uri.parse(
          'https://www.association-sarrazi.fr/liste_artisans.php')); // ← adapte ton URL
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Ils habitent le hameau"),
      ),
      body: isLoading
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Icon(Icons.person_pin_circle, size: 32, color: Colors.brown),
                      SizedBox(width: 10),
                      Expanded(
                        child: Text(
                          artisan['intitule'],
