...
class _InformationPageState extends State<InformationPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Infos pratiques'), backgroundColor: Colors.teal),
      body:
          actualites.isEmpty
                      ...
                      child: Column(
                        ...
                        children: [
                          Html(
                            ...
                            style: {"body": Style(fontSize: FontSize(16), color: Colors.black87), "a": Style(color: Colors.teal, textDecoration: TextDecoration.underline)},
                          ),
                          Align(
                            alignment: Alignment.bottomRight,
                            child: Text(DateFormat("dd/MM/yyyy").format(actualite.dateAjout), style: TextStyle(fontSize: 12, fontStyle: FontStyle.italic, color: Colors.grey[600])),
                          ),
                        ],
                      ),
                    ),
